// Package stubllm provides a deterministic, semantically meaningful LLM stub
// for integration testing. It implements llm.Provider using bag-of-words
// embeddings and template-based completions, producing consistent results
// that exercise encoding, retrieval, and association pipelines without
...
// Provider implements llm.Provider with deterministic,
// semantically meaningful embeddings and template-based completions.
type Provider struct{}

func (s *Provider) Complete(_ context.Context, req llm.CompletionRequest) (llm.CompletionResponse, error) {
...
func (s *Provider) Embed(_ context.Context, text string) ([]float32, error) {
	return BowEmbedding(text), nil
}

func (s *Provider) BatchEmbed(_ context.Context, texts []string) ([][]float32, error) {
...
func (s *Provider) Health(_ context.Context) error {
	return nil
}

func (s *Provider) ModelInfo(_ context.Context) (llm.ModelMetadata, error) {
